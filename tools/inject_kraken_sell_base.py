...
Usage:
  python tools/inject_kraken_sell_base.py --base-url https://<bus> --secret <OUTBOX_SECRET> \
    --agent edge-primary --symbol XBT/USDT --amount-base 5e-05
...
def main():
    ...
    body = _make_body(args.agent, cmd, "inject_kraken_sell_base.py", now)
